...
type MotherboardIconProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};

//www.svgrepo.com/svg/255695/motherboard
export function MotherboardIcon({ size = 24, ...props }: MotherboardIconProps) {
  return (
    <svg
      fill="currentColor"
      version="1.1"
